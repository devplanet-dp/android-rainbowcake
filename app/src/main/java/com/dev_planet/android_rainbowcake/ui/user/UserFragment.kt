...
import com.dev_planet.android_rainbowcake.R
import kotlinx.android.synthetic.main.fragment_user.*

class UserFragment : RainbowCakeFragment<UserViewState, UserViewModel>() {

    override fun provideViewModel(): UserViewModel = getViewModelFromFactory()

    override fun getViewResource(): Int = R.layout.fragment_user
